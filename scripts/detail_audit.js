...
async function main() {
    try {
        ...
        articles.forEach((a, i) => {
            ...
            console.log(`- Facts Main: ${a.keyFactsJson}`);
            console.log(`- Facts ES: ${es?.keyFactsJson}`);
            console.log(`- Content HTML (End): ${es?.contentHtml?.slice(-200)}`);
            console.log(`- Img URL: ${a.imageUrl}`);
        });
    } catch (e) {
