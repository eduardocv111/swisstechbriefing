...
export const apiService = {
    ...
    getHome: (locale: string = 'de-CH') =>
        apiClient.get<any, ApiResponse<HomeResponse>>(`/home?locale=${locale}`),
    ...
    getLatest: (locale: string = 'de-CH', limit: number = 20) =>
        apiClient.get<any, ApiResponse<MobileArticle[]>>(`/articles/latest?locale=${locale}&limit=${limit}`),
    ...
    getArticle: (slug: string, locale: string = 'de-CH') =>
        apiClient.get<any, ApiResponse<MobileArticle>>(`/articles/${slug}?locale=${locale}`),
    ...
    getRelated: (slug: string, locale: string = 'de-CH', limit: number = 3) =>
        apiClient.get<any, ApiResponse<MobileArticle[]>>(`/articles/related?slug=${slug}&locale=${locale}&limit=${limit}`),
    ...
    getCategoryArticles: (slug: string, locale: string = 'de-CH', page: number = 1, limit: number = 20) =>
        apiClient.get<any, ApiResponse<MobileArticle[]>>(
