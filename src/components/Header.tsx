...
export default function Header() {
    return (
        <header className="sticky top-0 z-50 bg-[#0a0f1a] text-white px-4 h-16 sm:h-14 flex items-center justify-between shadow-sm border-b border-white/5">
            <div className="flex items-center gap-2">
                <Link href="/" className="hover:opacity-90 transition-opacity flex items-center h-full">
                    {/* 
                     * Logo sizing:
                     * Mobile (<640px): h-10 w-52 → BIG, premium, centrado visual
                     * Desktop (≥640px): h-8 w-44 → standard desktop size
                     */}
                    <div className="relative h-10 w-52 sm:h-8 sm:w-44">
                        <Image
